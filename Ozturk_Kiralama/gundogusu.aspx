<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gundogusu.aspx.cs" Inherits="gundogusu" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Yat Kiralama  -GÜNDOĞUŞU</title>
</head>
            ...
            <div class="col-sm-9 float-left">
                ...
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="img/gündogusu.jpg" class="card-img" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>Yatın Özellikleri;</strong> <br /> <hr />
                                    ...
                                    <strong>Uzunluk:</strong> 18MT <br />
                                    <strong>Genişlik:</strong> 5MT <br />
                                    <strong>Kapasite:</strong> 35 Kişi <br /> 
                                    <strong>Yemekli:</strong> 15 Kişi <br />
                                    <strong>Kokteyl:</strong> 20 Kişi
</p>
                                ...
                                <br />
                                <p class="card-text"><small class="text-muted">4 Gün önce eklendi.</small></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/gundogusu1.jpg" class="d-block w-100" alt="...">
                            ...
                            <div class="carousel-item">
                                <img src="img/gundogusu2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="img/gundogusu3.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="img/gundogusu4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gunbatisi.aspx.cs" Inherits="gunbatisi" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Yat Kiralama  -GÜNBATIŞI</title>
</head>
            ...
            <div class="col-sm-9 float-left">
                ...
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="img/gunbatisi.jpg" class="card-img" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>Yatın Özellikleri;</strong> <br /> <hr />
                                    ...
                                    <strong>Uzunluk:</strong> 22MT <br />
                                    <strong>Genişlik:</strong> 5,50MT <br />
                                    <strong>Kapasite:</strong> 55 Kişi <br /> 
                                    <strong>Yemekli:</strong> 25 Kişi <br />
                                    <strong>Kokteyl:</strong> 30 Kişi
                                &nbsp;</p>
                                ...
                                <br />
                                <p class="card-text"><small class="text-muted">7 Gün önce eklendi.</small></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/gunbatisi1.jpg" class="d-block w-100" alt="...">
                            ...
                            <div class="carousel-item">
                                <img src="img/gunbatisi2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="img/gunbatisi3.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="img/gunbatisi4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">

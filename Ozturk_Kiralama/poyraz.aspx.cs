...
public partial class poyraz : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@yat2", "POYRAZ");
        ...
        cmd2.Parameters.AddWithValue("@yat", "POYRAZ");
    ...
    protected void btngonder_Click(object sender, EventArgs e)
    {
        ...
        if (txtadsoyad.Text != "" && txtyorum.Text != "")
        {
            ...
            if (dr2.Read())
            {
                ...
                cmd.Parameters.AddWithValue("@yat_isim", "POYRAZ");
    ...
    protected void Calendar1_SelectionChanged(object sender, EventArgs e)
    {
        ...
        while (dr2.Read())
        {
            ...
            cmd.Parameters.AddWithValue("@yat", "POYRAZ");
            SqlDataReader dr = cmd.ExecuteReader();
            if (dr.Read())
            {

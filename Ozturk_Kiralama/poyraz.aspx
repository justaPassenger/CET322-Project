<%@ Page Language="C#" AutoEventWireup="true" CodeFile="poyraz.aspx.cs" Inherits="poyraz" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Yat Kiralama  -POYRAZ</title>
</head>
            ...
            <div class="col-sm-9 float-left">
                ...
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="img/poyraz.jpg" class="card-img" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>Yatın Özellikleri;</strong> <br /> <hr />
                                    ...
                                    <strong>Uzunluk:</strong> 19MT <br />
                                    <strong>Genişlik:</strong> 5,15MT <br />
                                    <strong>Kapasite:</strong> 41 Kişi <br /> 
                                    <strong>Yemekli:</strong> 16 Kişi <br />
                                    <strong>Kokteyl:</strong> 25 Kişi
</p>
                             ...
                             <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Tarih :"></asp:Label>
                                ...
                                <asp:Button ID="Button1" runat="server" class="btn btn-outline-success my-2 my-sm-0" Text="Kirala" OnClick="btnkirala_Click" />
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/poyraz1.jpg" class="d-block w-100" alt="...">
                            ...
                            <div class="carousel-item">
                                <img src="img/poyraz2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="img/poyraz3.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="img/poyraz4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">

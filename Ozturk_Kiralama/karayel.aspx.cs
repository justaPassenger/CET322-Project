...
public partial class karayel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@yat2", "KARAYEL");
        ...
        cmd2.Parameters.AddWithValue("@yat", "KARAYEL");
    ...
    protected void btngonder_Click(object sender, EventArgs e)
    {
        ...
        if (txtadsoyad.Text != "" && txtyorum.Text != "")
        {
            ...
            if (dr2.Read())
            {
                ...
                cmd.Parameters.AddWithValue("@yat_isim", "KARAYEL");
    ...
    protected void Calendar1_SelectionChanged(object sender, EventArgs e)
    {
        ...
        while (dr2.Read())
        {
            ...
            cmd.Parameters.AddWithValue("@yat", "KARAYEL");
            SqlDataReader dr = cmd.ExecuteReader();
            if (dr.Read())
            {

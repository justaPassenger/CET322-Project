<%@ Page Language="C#" AutoEventWireup="true" CodeFile="meltem.aspx.cs" Inherits="meltem" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Yat Kiralama  -MELTEM</title>
</head>
            ...
            <div class="col-sm-9 float-left">
                ...
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="img/meltem.jpg" class="card-img" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                          ...
                          <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Tarih :"></asp:Label>
                                ...
                                <br />
                                <p class="card-text"><small class="text-muted">9 Gün önce eklendi.</small></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/meltem1.jpg" class="d-block w-100" alt="...">
                            ...
                            <div class="carousel-item">
                                <img src="img/meltem2.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="img/meltem3.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="img/meltem4.jpg" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
